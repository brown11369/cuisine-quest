            ...
            <div className="container advertisement">
                <div className="container-center">
                    <div className="advertisement-box left">
                        <h2>Fresh Summer With<br />Pineapple juice</h2>
                    ...
                    <div className="advertisement-box right">
                        <h2>Fresh Vegetable With<br />Healthy Body</h2>
                        <span className="off">350 Rs./-</span><br />
                        {/* <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla accumsan justo sed metus egestas, ac tempus mi sodales.</p> */}
                        <button className="btn ad-btn">Shop Now</button>
                    </div>
                </div>
            ...
            < section className="container" >
                <div className="subscribe">
                    <div className="subscribe-container">
                        <h1 className="subscribe-title">Get <span className="off">25%</span> Discount</h1>
                        <p className="subscribe-text">Subscribe to the Martfury mailing list
                            to receive updates on new arrivals, special offers
                            and our promotions.
                        </p>
                        <div className="search-box">
                            <input className="search-input" type="text" placeholder="Enter Your Email" />
                            <button className="btn search-btn">Search</button>
                        </div>
                    </div>
                    <div className="subscribe-container">
                        <img className="subscribe-image" src="./media/img/meal.jpg" alt="meal" />
                    </div>
                </div>
            </section >
        </>
